...
if __name__ == '__main__':
    ...
    s1 = meshIn.rectangle(-5.0,1.0,5.0,10.76,9,21,(3,0,3,1),0.0,0.5,0.1,0.1)
    s2 = meshIn.rectangle(0.0,1.0,17.92,10.76,18,21,(0,2,3,0),0.5,0.0,0.1,0.1)
    s3 = meshIn.rectangle(0.0,0.0,17.92,1.0,18,5,(3,2,0,3),0.5,0.0,0.1,0.1)
    
    sint = s1 + s2 + s3
    
    s = depth(sint.points,sint.connect,sint.bc,0.05,2,(2,2))
    
    simplemesh('bfs_notuniform',s.points,s.connect,s.bc,6,6,6)
